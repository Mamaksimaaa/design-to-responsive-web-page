...
const gameSupport = [
  "kys-hub-cracked",
  "nibum-muscle-legends",
  "nibum-myfishingbrainrot",
  "nibum-mm2",
  "evade",
  "merge-a-nuke",
  "muscle-legends",
  "invisible-fe-universal",
  "mm2",
  "doors",
  "dead-rails",
  "ghost-driver",
              ...
              <div className="grid grid-cols-[52px_1fr] sm:grid-cols-[150px_1fr]">
                ...
                <div className="p-4 sm:p-5">
                  {active === 1 ? (
                    ...
                    <>
                      ...
                      {tab < 3 ? (
                              ...
                              return (
                                <label key={s.label} className="block">
                                  ...
                                  <input
                                    ...
                                    aria-label={s.label}
                                    className="mt-1.5 h-1.5 w-full cursor-pointer appearance-none rounded-full accent-neon [&::-webkit-slider-thumb]:size-3.5 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-neon [&::-webkit-slider-thumb]:shadow-[0_0_10px_rgba(255,42,42,0.8)] [&::-moz-range-thumb]:size-3.5 [&::-moz-range-thumb]:appearance-none [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:border-0 [&::-moz-range-thumb]:bg-neon [&::-moz-range-thumb]:shadow-[0_0_10px_rgba(255,42,42,0.8)]"
                                    style={{
                        ...
                        <div className="mt-4 max-h-48 overflow-y-auto">
                          <p className="font-condensed text-xs font-bold uppercase tracking-widest text-neon/80 mb-3">Supported Games</p>
                          <div className="space-y-1.5">
                            {gameSupport.map((game) => (
                              <div key={game} className="flex items-center gap-2 rounded-md border border-white/5 bg-ink/40 px-3 py-2 text-xs text-bone/75">
                    ...
                    <>
                      <p className="font-condensed text-sm font-bold uppercase tracking-widest text-neon">Settings</p>
                      <div className="mt-4 space-y-3">
                        <div className="text-xs text-bone/75">Select a section from the sidebar to configure settings</div>
                      </div>
                    </>
                  )}
                </div>
